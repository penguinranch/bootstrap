...
| Practice                       | Source                                                                                                                                                   | Notes                                                                                                                                                                                                                                                                                                                                     |
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Agent instructions in the repo | [`templates/AGENTS.md`](templates/AGENTS.md)                                                                                                             | The single most impactful AI-native practice: one file stating working judgment, constraints, philosophy, lifecycle rules, branching strategy, and orchestrator-pattern subagent delegation. Adapt, don't copy.                                                                                                                           |
...
| Pre-configured MCP servers     | [`templates/.mcp.json`](templates/.mcp.json), [`.gemini/settings.json`](templates/.gemini/settings.json)                                                 | Project-scoped MCP config shipped by default (Claude Code + Gemini CLI): Notion, Context7, and GitHub via official remote HTTP endpoints (OAuth / env-expanded keys from `.env`), Playwright and Chrome DevTools via local `npx` servers. No secrets committed — env expansion only. Prune unused servers and keep the two files in sync. |
